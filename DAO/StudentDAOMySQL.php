<?php 
    ...
    class StudentDAOMySQL implements IStudentDAO { 
        ...
        private function consumeFromApi(){ 
            $this->studentList = array(); 
            $options = array( 'http' => array( 'method'=>"GET", 'header'=>"x-api-key: " . API_KEY) ); 
        ...
        public function Add(Student $student) { 
            $sql = "INSERT INTO students (student_id, career_id, first_name, last_name, dni, file_number, gender, email, birth_date, phone_number, active, password) VALUES (:student_id, :career_id, :first_name, :last_name, :dni, :file_number, :gender, :email, :birth_date, :phone_number, :active, :password);"; 
            ...
            $parameters['active']=true; $parameters['password']=$student->getPassword(); 
        ...
        /* public function Delete($idToDelete){ 
         ...
         public function Update($student, $toFind){ 
            $sql = "UPDATE students set careerId=:careerId, firstName=:firstName, lastName=:lastName, dni=:dni, fileNumber=:fileNumber, gender=:gender, birthDate=:birthDate, email=:email, phoneNumber=:phoneNumber WHERE studentId= '$toFind';"; 
    ...
    /* private function mapear($studentList){ 
        ...
        $newStudent = new Student($pos['careerId'],$pos['firstName'],$pos['lastName'],$pos['dni'],$pos['fileNumber'],$pos['gender'], $pos['birthDate'],$pos['email'],$pos['phoneNumber'],$pos['password']);
        //crear student 
