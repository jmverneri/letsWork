<nav class="navbar navbar-expand-lg navbar-dark bg-dark mb-4">
    <div class="container">
        <a class="navbar-brand" href="<?php echo FRONT_ROOT ?>Company/dashboard">
            ...
            <strong>LETS WORK</strong> <span class="badge badge-info">Company</span>
        </a>

        <div class="collapse navbar-collapse">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo FRONT_ROOT ?>CompanyJobOffer/listMyOffers">My Offers</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo FRONT_ROOT ?>Company/profile">Profile</a>
                </li>
